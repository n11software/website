...
let EmployeesPage = props => {
  return <>
    {props.bool ? <div className="flex flex-col fixed z-30 w-32 bg-black text-gray-200 top-18 rounded-lg shadow select-none" style={{left: "14.78rem"}}>
      <Link href="/employees/filter/developers">
        <a className="rounded-t-lg hover:bg-stone-900 py-2 text-center">Developers</a>
      </Link>
      ...
      <Link href="/employees">
        <a className="rounded-b-lg hover:bg-stone-900 py-2 text-center">See all</a>
      </Link>
    </div>: <></>}
