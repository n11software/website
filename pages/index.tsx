  ...
  return <>
    ...
    <div className="w-screen h-screen flex">
      <div className="flex flex-col text-stone-800 w-full pt-32 pl-24">
        ...
        <span className="text-2xl w-3/4 text-stone-600 mb-12">N11 is a business focused on creating things from nothing making them secure, fast, and modern looking.</span>
        <ApplyButton type={1}/>
      </div>
